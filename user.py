...
from tkinter import messagebox # tkinter is used for gui
import os
...
class userInterface:
    def __init__(self):
        ...
        self.user.title("Restaurant System (User)")
        self.user.protocol("WM_DELETE_WINDOW", self.breakWindow)

        self.topBar = ttk.Frame(self.user)
        ...
        self.name = StringVar()
        self.name.set("")
        self.entry_name = ttk.Entry(self.body)
        ...
        self.entry_reserveDate = ttk.Entry(self.body)
        ...
        self.entry_reserveTime = ttk.Entry(self.body)
        ...
        self.peopleNum.set("")
        self.entry_peopleNum = ttk.Entry(self.body)
    ...
    def insert_initial_data (self) -> None: # insert data into schema storing food menu and details
        self.cur.execute(
            """
    ...
    def addReserve(self, name : str, reserveDate : str, reserveTime : str, table_id : str, foodReserve : str, endTime : str) -> None:
    ...
    def foodReserveUI (self) -> None:
        ...
        self.table_itemOrdered.heading(
            "orderedcol_amount", anchor="center", text='Amount')
    ...
    def table_itemOrdered_mouseWheelScroll (self, event) -> None:
    ...
    def buildReserveFoodMenu (self) -> None:
        ...
        # query from dish_list schema and insert into tkinter treeview
    ...
    def dineIn (self) -> None:
        ...
        self.table_foodList.configure(height=15,
                                      ...
                                      show="headings",
                                      takefocus=True)
        self.table_foodList_cols = [
            'col_foodID', 'col_foodName', 'col_foodPrice']
        self.table_foodList_dcols = [
            'col_foodID', 'col_foodName', 'col_foodPrice']
        self.table_foodList.configure(columns=self.table_foodList_cols,
                                      displaycolumns=self.table_foodList_dcols)
        self.table_foodList.column("#0",
    ...
    def updateReserveKitchenSQL (self) -> None:
        ...
        self.cur.execute(
            """
                SELECT r.id, r.reserve_time, rd.dish_id, rd.dish_amount
                FROM reservation r 
                JOIN
                reserve_dish rd
                ON r.id = rd.reserve_id
        ...
        if category == 'RESERVE':
            self.cur.execute(
                """
                    ...
                    WHERE time = ? AND
                        id = ? AND
                        dish_name = (SELECT dish_id from dish_list WHERE dish_name = ?) AND
                        dish_amount = ? 
    ...
    def table_management (self) -> None:
        ...
        self.tableFrame_tableAvail.configure(
            height=200, labelanchor="n", text='Table Available', width=200)
        ...
        self.table_tableInUse.column("tableInUseCol_capacity",
                                     ...
                                     width=200,
                                     minwidth=20)
        self.table_tableInUse.heading("tableInUseCol_ID", 
                                      anchor="center", 
                                      text='ID')
        self.table_tableInUse.heading("tableInUseCol_capacity",
                                      anchor="center",
                                      text='Capacity')
